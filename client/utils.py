...
category = calculate(timeframe_start, timeframe_end, group_by=category, filter_by=Tag.BROTHER_RENT,)
top_five_merchants = calculate(timeframe_start, timeframe_end, group_by=merchant, sort_by=(amount, DESC), filter_by=Tag.BROTHER_RENT,)
top_five_locations = calculate(timeframe_start, timeframe_end, group_by=location,  sort_by=(amount, DESC), filter_by=Tag.BROTHER_RENT,)

How to Do YTD Expenditure
spending = get(timeframe_start, timeframe_end)
rent_applicable_spending = get(timeframe_start, timeframe_end, filter_by=Tag.BROTHER_RENT)
"""
